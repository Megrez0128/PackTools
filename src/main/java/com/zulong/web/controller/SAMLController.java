...
//            }else{
//                ///Idp登录信息存在，根据IdP登录信息获取SP的登录信息，并回调至指定资源页
//                redirectToURL(userInfo, goToURL, request, response);
//            }
//        } catch (Exception e) {
//            LoggerManager.logger().error("samlLogin: exception,ip={}", ip, e);
////            response.sendRedirect("https://res.zulong.com/global_page/default_error.html");
//        }
//    }
...
//                    append("/auth/user/returntoken").toString();
//                goToURL = UriComponentsBuilder.fromUriString(goToURL)
